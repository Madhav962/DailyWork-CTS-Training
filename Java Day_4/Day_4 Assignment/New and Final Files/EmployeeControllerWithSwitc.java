...
public class EmployeeControllerWithSwitc {
	...
	do {
		...
		case 1:
			...
			System.out.println("Enter designation for an employee: ");
			...
			long P = src.nextLong();
			Employee emp = new Employee(i, N , A, D, Ag, S, P);
		...
		case 3:
			...
			empObj.deleteEmployee(empObj.getEmployeeById(4234));
			List<Employee> list3 = empObj.getAllEmployees();
			list3.forEach(System.out::println);
			System.out.println();
			break;
		case 4:
			System.out.println("********** Getting Employee info by its ID **********");
			if (empObj.getEmployeeById(4234) == null)
